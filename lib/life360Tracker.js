...
${
  ...
  <span class="leg-entry">
    <svg class="leg-svg" width="16" height="16" viewBox="0 0 16 16">
      <circle cx="8" cy="8" r="6" fill="${headerFg}" stroke="#ffffff" stroke-width="1.5" opacity="0.9"/>
    </svg>
    Startpunkt
  </span>
  <span class="leg-entry">
    <svg class="leg-svg" width="16" height="16" viewBox="0 0 16 16">
      <circle cx="8" cy="8" r="5" fill="${headerFg}" stroke="#ffffff" stroke-width="1.5" opacity="0.5"/>
    </svg>
    Zwischenpunkt
  </span>
  <span class="leg-entry">
