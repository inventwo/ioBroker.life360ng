...
<style>:root{--page-bg:${c.pageBg};--header-bg:${c.headerBg};--header-border:${c.headerBorder};--fg:${headerFg};--ctrl-bg:${controlBg};--ctrl-border:${controlBorder};--ctrl-hover:${controlHoverBg}}body,input[type=date]{color-scheme:${colorScheme}}@media(max-width:900px){#header-right{width:auto}}</style>
</head>
<body>
<div id="header">
	<h2>\uD83D\uDCCD ${firstName}</h2>
...
#hamMenu{position:relative;margin-left:auto}
