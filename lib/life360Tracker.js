...
#header{padding:8px 14px;background:var(--header-bg,#16213e);display:flex;align-items:center;font-size:13px;border-bottom:2px solid var(--header-border,#0f3460);flex-wrap:wrap;gap:6px;min-height:44px}
