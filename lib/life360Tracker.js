...
function personShowRange(from,to){
  ...
  feats.forEach(function(feat){
    ...
    pl.on('click',function(){_blockMapClick=true;_hoverActive=false;var dh=document.getElementById('menuDayHighlight');if(dh&&dh.checked){_highlightGroup(feat.date);}});
