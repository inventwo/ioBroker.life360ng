...
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  #legend { color:${c.headerText}; font-size:12px; display:flex; align-items:center; gap:8px; flex-wrap:wrap; }
  .legend-actions { display:flex; align-items:center; gap:6px; flex-wrap:wrap; }
  .legend-btn { background:${c.headerBg}; color:#eee; border:1px solid ${c.headerBorder}; border-radius:4px; padding:4px 8px; font-size:12px; cursor:pointer; }
  .legend-btn:hover { opacity:0.9; }
