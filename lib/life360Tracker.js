...
${c.showPlaces ? `		   <label class="route-checkbox-label"><input type="checkbox" id="showPlaces"> ${this._t("places")}</label>` : ""}
${c.showMyPlaces ? `		   <label class="route-checkbox-label"><input type="checkbox" id="showMyPlaces"> ${this._t("myPlaces")}</label>` : ""}
	</div>
</div>
<div id="map"></div>
<div id="footer">
...
return L.divIcon({
className: '',
html: '<svg xmlns="http://www.w3.org/2000/svg" width="' + w + '" height="' + h + '" viewBox="0 0 24 24"><path fill="' + color + '" d="M14.4,6L14,4H5V21H7V14H12.6L13,16H20V6H14.4Z"/></svg>',
iconSize: [w, h],
iconAnchor: [0, h],
